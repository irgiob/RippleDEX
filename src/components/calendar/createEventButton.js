...
const CreateEventButton = (props) => {
    ...
    const createEvent = () => {
        props.createEventObject(title, startDate, startTime, endTime, isAllDay)
    }
            ...
            <Modal isOpen={isOpen} onClose={closeModal}>
                ...
                <ModalBody>
                    ...
                    <HStack margin="10px">
                        ...
                        <TimePicker onChange={setEndTime} value={endTime} disabled={isAllDay} disableClock={true}/>
                ...
                <ModalFooter>
                    ...
                    float="right"
                    size="lg"
                    onClick={()=>{closeModal(); createEvent();}}>Create</Button>
                </ModalFooter>
                </ModalContent>
            </Modal>
        </>
